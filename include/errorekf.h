...
std::unique_ptr<Matrix<double, 3, 3>> sv, Rv, tempM;
...
std::unique_ptr<Eigen::Matrix<double, 6, 6>> R_z;
/// Updated Error Covariance matrix
std::unique_ptr<Eigen::Matrix<double, 15, 15>> P_i;
/// Corrected state
std::unique_ptr<Eigen::Matrix<double, 15, 1>> x_i, x_i_;
std::unique_ptr<Eigen::Matrix3d> Rib_i;
bool outlier;
